...
const SPiechart = (props) => {
    ...
    return (
        <div>
            <h1 className='mt-5 pt-3'>Sales Pie chart</h1>
            <h5 className='pt-3 pb-3'>The ratio percentage of total order and amount of each brand's property order is shown through this line diagram. By hovering each section in the pie chart, the total percentage of order of each brand's property can be known. The brand with higher percentage is the most popular brand for sale.</h5>
