                    ...
                    <div className="list-group list-group-flush">
                        ...
                        {(found?.role === 'Normal' || user.role === 'Normal') &&
                            <div>
                                ...
                                <Link to={`${url}/charts`} className="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                                    className="fas fa-gift me-2"></i>Product Chart</Link>
                                <Link to={`${url}/salesCharts`} className="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                                    className="fas fa-gift me-2"></i>Sales Charts</Link>
                ...
                <div className="container" id="page-content-wrapper">
                    ...
                    <div className="container">
                        ...
                        <Switch>
                            ...
                            <PrivateRoute path={`${path}/charts`}>
                                <Charts></Charts>
                            </PrivateRoute>

                            <PrivateRoute path={`${path}/salesCharts`}>
