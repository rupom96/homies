...
const Details = () => {
    ...
    const createDoc = (user, data, found) => {
        ...
        console.log(doc);
        // axios.post('')
        axios.post('https://limitless-shore-01631.herokuapp.com/orders', doc)
            .then(res => {
                if (res.data.insertedId) {
                    alert('This property has been Ordered successfully');
        ...
        <div className="mt-5 pt-5">
            ...
            <div>
                ...
                <div className="container">
                    <h4 className="mt-5 mb-5 pb-3">Provide necessary info to book the property:</h4>
                    ...
                    <form className="container text-start w-75" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="btn btn-primary btn-lg" type="submit" value="Purchase this Property" />
                    </form>
